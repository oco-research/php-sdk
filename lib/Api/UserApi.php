...
class UserApi
{
     ...
     * Create user
     *
     * @param  \GarageWeek\PetStoreClient\User $user Created user object (optional)
     *
     * @throws \GarageWeek\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GarageWeek\PetStoreClient\User
     */
     ...
     * @throws \GarageWeek\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GarageWeek\PetStoreClient\User, HTTP status code, HTTP response headers (array of strings)
     */
    public function createUserWithHttpInfo($user = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                default:
                    if ('\GarageWeek\PetStoreClient\User' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\GarageWeek\PetStoreClient\User', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\GarageWeek\PetStoreClient\User';
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\GarageWeek\PetStoreClient\User',
     ...
     *
     * @param  \GarageWeek\PetStoreClient\User[] $user user (optional)
     *
     * @throws \GarageWeek\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GarageWeek\PetStoreClient\User
     ...
     * Creates list of users with given input array
     *
     * @param  \GarageWeek\PetStoreClient\User[] $user (optional)
     *
     * @throws \GarageWeek\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GarageWeek\PetStoreClient\User, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \GarageWeek\PetStoreClient\User $user Update an existent user in the store (optional)
     *
     * @throws \GarageWeek\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
